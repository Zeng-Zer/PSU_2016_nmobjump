...
static char	type_uvw32(Elf32_Sym *sym, Elf32_Shdr *shdr)
{
  char		c;
...
static char	type_shndx32(Elf32_Sym *sym, Elf32_Shdr *shdr)
{
  char		c;
...
static char	type_brd32(Elf32_Sym *sym, Elf32_Shdr *shdr)
{
  char		c;
...
static char	type_tdn32(Elf32_Sym *sym, Elf32_Shdr *shdr)
{
  char		c;
